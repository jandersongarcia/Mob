...
namespace core\Packages\UserFlow;
...
class UserFlow extends MySQL
{
    ...
    public function __construct()
    {
        ...
        if (isset($error)) {
            ...
            $value = "<br/>Error executing userflow";
    ...
    private function MVC($name = false)
    {
        ...
        if (isset(APP['language'])) {
            $lang = APP['language'];
            $langFilePath = ROOT . "packages/userflow/lang/$lang.php";
        ...
        $file = ROOT . "packages/userflow/$name/$name";
        ...
        if (file_exists($modalFilePath) && file_exists($controllerFilePath) && file_exists($viewFilePath)) {
            ...
            echo '<div class="container vh-100 d-flex justify-content-center align-items-center">
                <div class="alert alert-danger text-center" role="alert">
                  ...
                  <div class="mt-3 border rounded font-monospace bg-light p-3">'.$modalFilePath.'<br>'.$controllerFilePath.'<br>'.$viewFilePath.'</div>
                </div>
              </div>';
        }
    }
